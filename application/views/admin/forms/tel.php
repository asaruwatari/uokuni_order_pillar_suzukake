...
<div class="form-group">
    ...
    <div class="field">
        <input type="tel" name="<?= h($field) ?>" class="form-control" style="<?= @$unit ? 'display:inline-block; width:10em' : '' ?>" value="<?= set_value($field, isset($data[$field]) ? $data[$field] : '') ?>" placeholder="<?= @$guide ?: '' ?>" <?= $readonly ? 'readonly' : '' ?> autocorrect="off" autocomplete="off" autocapitalize="off">
        <?= @$unit ?: '' ?>
